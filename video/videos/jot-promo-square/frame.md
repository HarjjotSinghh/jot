...
description: >
  ...
  display + Inter body + Cascadia Mono for the index/code voice on a warm-navy code surface,
...
typography:
  ...
  kicker:  { fontFamily: "Cascadia Mono", px: 28, cqw: 1.46, weight: 500, tracking: "0.16em", upper: true }
  mono-label:{ fontFamily: "Cascadia Mono", px: 26, cqw: 1.35, weight: 500, tracking: "0.02em" }
  code:    { fontFamily: "Cascadia Mono", cqw: 1.67, weight: 400, lineHeight: 1.6 }
  ...
  number-unit:{ fontFamily: "Cascadia Mono", cqw: 2.08, weight: 500, lineHeight: 1.0 }
...
components:
  ...
  kicker-spike:
    ...
    description: "The eyebrow — Cascadia Mono uppercase, indexical (2–5 words), prefixed with the coral ✱. Never plain text, never a sentence."
  coral-callout:
  ...
  number-lockup:
    ...
    description: "Hero stat — a Inter figure paired with a Cascadia Mono unit (200K, +1,204, −318, 17 files). Figure is serif; the unit is ALWAYS mono, never the serif."
  pull-quote:
  ...
  code-surface:
    ...
    textColor: "{colors.cream} (Cascadia Mono); syntax in coral (keywords) / teal #5DB8A6 (strings) / amber #E8A55A (numbers)"
...
- **Fonts** — already set to **Inter** (display) / **Cascadia Mono** (body); ignore any preset font name lingering in prose.
...
UI chrome. **Cascadia Mono** carries the indexical layer — kickers, technical labels, the code
...
- **Inter** (sentence case, negative-tracked) for all display; **Inter** body/chrome; **Cascadia Mono** index + code.
...
- **Type** — Inter sentence-case display (negative-tracked); Inter 400 body; Cascadia Mono kickers (uppercase 0.16em, coral ✱) + code.
...
- Set all display in **Inter, sentence case**, negative-tracked; **Inter 400** body; **Cascadia Mono** kickers (uppercase, 0.16em, coral ✱) + code.
...
- **Type** — Inter sentence-case display (negative-tracked); Inter 400 body; Cascadia Mono kickers (uppercase 0.16em, coral ✱) + code; ≥1.4cqw floor.
